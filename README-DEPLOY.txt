ReadPlanner Build 110 deployment
================================
...
3. Upload every file and folder from this unzipped Build 110 package directly over the existing repository-root files. Keep the icons/ and vendor/ folder structure.
